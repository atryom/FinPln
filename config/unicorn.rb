...
@app = "/home/deployer/finpln/current"  # путь к нашему размещенному приложению, разумеется project_name меняем на ваш везде
@shared = "/home/deployer/finpln/shared"  # путь к shared папке
